...
{
    [DbContext(typeof(DBWebData))]
    partial class DBWebDataModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Data.Entities.Users", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebApplication1.Data.Entities.Users", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplication1.Data.Entities.Order", b =>
                {
                    b.HasOne("WebApplication1.Data.Entities.Users", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
